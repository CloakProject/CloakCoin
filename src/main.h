...
extern int nEnigmaNodeMinimum;
extern std::set<CScript> sEnigmaAddresses;
...
static const uint256 hashMerkelRootOfficial("0x1831d9f590f8b705ed996fcaa37ece517cfa6eb619af6738b2606383eab5a619");
static const unsigned int blockTime = 1401537155;
static const unsigned int nNonce = 1363322;

static const uint256 hashGenesisBlockTestNet4 ("0xeb839aa81f3ec87bbaf993033d0a68219918b327a82709482e446b8ae0a21c4f");
static const uint256 hashMerkelRootTestNet4("0x1831d9f590f8b705ed996fcaa37ece517cfa6eb619af6738b2606383eab5a619");
...
extern std::map<uint160, CEnigmaAnnouncement> mapEnigmaAnns;
extern CCriticalSection cs_mapEnigmaAnns;

extern std::string nMyEnigmaAddress;

extern CCriticalSection cs_enigmaQueue;
...
friend bool operator==(const CEnigmaTxOut& a, const CEnigmaTxOut& b)
    {
        return (a.nHop == b.nHop && a.nValue       == b.nValue &&
...
class CEnigmaTransaction
{
public:
    static const int CURRENT_VERSION=1;
    int nVersion;
    std::vector<CEnigmaTxOut> vout;
    ...
    void SetNull()
    {
        nVersion = CEnigmaTransaction::CURRENT_VERSION;
        vout.clear();
    }
    ...
    {
        std::string str;
        str += "CEnigmaTransaction";
        str += strprintf("(hash=%s, vout.size=%" PRIszu ")\n",
