...
#define FORCE_TESTNET 5 // (4=TestNet4 for debug, 5=TestNet5, 0=Live) force running on testnet/devnet
...
#define CLOAKSHIELD_NUM_ROUTES_TEST 3
#define CLOAKSHIELD_NUM_HOPS_TEST 3
#define CLOAKSHIELD_ANNOUNCE_TIMEOUT_SECS 60
#define CLOAKSHIELD_DATA_TIMEOUT_SECS 60
...
#define ENIGMA_MAX_CHANGE_ADDRESSES 10 // number of change addresses to spread returned cloaking funds to for participants within a enigma tx
#define ENIGMA_FORCE_AUTO_RETRY 1 // force enigma auto retry always (for testing)
#define ENIGMA_BLOCK_AUTO_RETRY 0 // block enigma auto retry always (for testing)
#define ENIGMA_MAX_RETRIES 3 // bail after this many retry attempts
#define ENIGMA_CHANGE_ADDRESS_NUM 3 // base number of change addresses to use (we use this many + num_splits) for outputs

#define ENIGMA_DEBUGMODE 0
#define ENIGMA_DEBUGMSG_ENCRYPTION (ENIGMA_DEBUGMODE)

#define STR_HELPER(x) #x
#define STR(x) STR_HELPER(x)

#define ENIMGA_STR_REQ        "req"     STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_REQ_ACCEPT "racc"    STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_REQ_SIGN   "rsign"   STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_REQ_SIGNED "rsigned" STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_ONION_TX   "otx"     STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_MSG        "msg"     STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_DATA       "dat"     STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_ANNOUNCE   "ann"     STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_CHECK      "chk"     STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_CHECK_ACK  "chkack"  STR(ENIGMA_REQUEST_CURRENTVERSION)
#define ENIMGA_STR_ACK        "ack"     STR(ENIGMA_REQUEST_CURRENTVERSION)

#define ENABLE_IRC 0

//#define ENIGMA_ASSERTS

// how many extra nodes (above min nodes) do we need to safely onion route?
// currently set to 2 as a node or two may drop out during the Enigma negotiation for a tx.
#define CLOAK_SHIELD_MIN_NODE_BUFFER 2
...
extern bool fSyncing;
extern bool fDebugNet;
extern bool fDebugEnigma;
...
extern bool fDisableOnionRouting;
...
std::string FormatTimeFromSecs(int64 secs);
...
inline uint64 tallyAmounts(std::vector<uint64> amounts)
{
    uint64 res = 0;
...
{
    std::string s = strprintf("cloakcoin-%s", name);
