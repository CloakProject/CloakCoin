...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet *wallet, const CWalletTx &wtx)
{
    ...
    bool isEnigma = wtx.IsEnigma();

    if (isEnigma)
    {
        parts.append(TransactionRecord(hash, nTime, TransactionRecord::Enigma, "", -nDebit, nCredit));
    }
    ...
    else
    {
        ...
        else
        {
            ...
            //
            parts.append(TransactionRecord(hash, nTime, TransactionRecord::Enigma, "", nNet, 0));
        }
    }
